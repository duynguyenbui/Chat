    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeenId = table.Column<string>(type: "text", nullable: false),
                    SeenMessagesId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageUser", x => new { x.SeenId, x.SeenMessagesId });
                    table.ForeignKey(
                        name: "FK_MessageUser_Messages_SeenMessagesId",
                        column: x => x.SeenMessagesId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageUser_Users_SeenId",
                        column: x => x.SeenId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageUser_SeenMessagesId",
                table: "MessageUser",
                column: "SeenMessagesId");
